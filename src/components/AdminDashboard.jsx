        ...
        <Box sx={{ flexGrow: 1, p: 3, backgroundColor: '#e3f2fd', minHeight: '100vh' }}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={6} md={3}>
              <Paper elevation={3} sx={{ p: 2, display: 'flex', alignItems: 'center', backgroundColor: '#bbdefb' }}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <Paper elevation={3} sx={{ p: 2, display: 'flex', alignItems: 'center', backgroundColor: '#bbdefb' }}>
                ...
                <Typography variant="h6">Utility Breakdown</Typography>
              </Paper>
            </Grid>
          </Grid>
          ...
          <Grid container spacing={3} sx={{ mt: 3 }}>
            <Grid item xs={12} md={6}>
              <Paper elevation={3} sx={{ p: 2, backgroundColor: '#bbdefb' }}>
            ...
            <Grid item xs={12} md={6}>
              <Paper elevation={3} sx={{ p: 2, backgroundColor: '#bbdefb' }}>
                ...
                {/* Table or list of new user registrations */}
              </Paper>
            </Grid>
          </Grid>
          <Grid container spacing={3} sx={{ mt: 3 }}>
            ...
            <Grid item xs={12}>
              <Paper elevation={3} sx={{ p: 2, backgroundColor: '#bbdefb' }}>
                ...
                {/* List of upcoming tasks or events */}
              </Paper>
            </Grid>
          </Grid>
        </Box>

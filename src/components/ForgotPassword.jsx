      ...
      <div className="container mx-auto px-6 lg:px-16 relative z-10">
        <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-lg">
          ...
          <form className="space-y-6">
            ...
            <button type="submit" className="w-full bg-blue-500 text-white py-2 rounded hover:bg-blue-600 transition duration-300">Send Code</button>
          </form>
          <p className="text-blue-600 mt-4 text-center">
            Remembered your Password? <a href="/Login" className="text-blue-800 hover:underline">Login</a>
          </p>
        </div>
      </div>
    </div>
